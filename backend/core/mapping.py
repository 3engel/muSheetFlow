...
DEFAULT_MAPPING = [
    # Flutes
     {"Term": "flöte, flauto", "English": "Flute", "Deutsch": "Flöte"},
    {"Term": "piccolo, pikkolo", "English": "Piccolo", "Deutsch": "Pikkolo"},
    # Clarinets
    {"Term": "klarinette, clarinetto", "English": "Clarinet", "Deutsch": "Klarinette"},
    # Saxophones
    {"Term": "altsaxophon, sax alto, alto sax", "English": "Alto Saxophone", "Deutsch": "Altsaxophon"},
    {"Term": "tenorsaxophon, tenor sax", "English": "Tenor Saxophone", "Deutsch": "Tenorsaxophon"},
    {"Term": "baritonsaxophon, baritone sax", "English": "Baritone Saxophone", "Deutsch": "Baritonsaxophon"},
    # Brass
    {"Term": "trompete, tromba, trumpet", "English": "Trumpet", "Deutsch": "Trompete"},
    {"Term": "kornett, cornet", "English": "Cornet", "Deutsch": "Kornett"},
    {"Term": "flügelhorn, flicorno", "English": "Flugelhorn", "Deutsch": "Flügelhorn"},
    ...
    # Percussion
    {"Term": "schlagzeug, drum set, drums", "English": "Drum Set", "Deutsch": "Schlagzeug"},
    {"Term": "percussion, perkussion", "English": "Percussion", "Deutsch": "Percussion"},
    {"Term": "pauken, timpani", "English": "Timpani", "Deutsch": "Pauken"},
    {"Term": "mallets, stabspiele", "English": "Mallet Percussion", "Deutsch": "Mallets"}
]
...
def standardize_name(filename, target_language="English"):
    ...
    for entry in mapping:
        ...
        targets = {"English": entry.get("English", ""), "Deutsch": entry.get("Deutsch", "")}
    ...
    if key_match:
        ...
        if found_val == 'es': found_val = 'eb'
        key_found = found_val.title()

    return {
        "instrument": recognized_instrument,
        "voice": voice,
        "key": key_found
    }
